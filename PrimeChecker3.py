...
def main():
    ...
    factors = [1, test_number]  # 1 and the test number is included because all ints are divisible by 1 and itself
    ...
    while test_factor < test_limit:
        if test_number % test_factor == 0:
            ...
            test_limit = math.ceil((test_number / test_factor))  # Eliminates numbers that could not possibly be factors
